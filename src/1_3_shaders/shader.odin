...
/*
    ...
    Cmdline:
        sokol-shdc -i src/1_3_shaders/shader.glsl -o src/1_3_shaders/shader.odin -l glsl430:metal_macos:hlsl5 -f sokol_odin
...
shader_shader_desc :: proc "c" (backend: sg.Backend) -> sg.Shader_Desc {
    desc: sg.Shader_Desc
